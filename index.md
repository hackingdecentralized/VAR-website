...
1. Users generate or import a seed, then derive the public/private key pair from that seed.

![Generate/import user seed](figs/TrueReach-Demo-Seed.png)

2. Users subscribe to TrueReach (the feed generator), and their public keys are automatically registered with it.

![Subscribe to TrueReach](figs/TrueReach-Demo-Feed.png)

3. The users view the promoted content and spend the receipt automatically.

![View the promoted content](figs/TrueReach-Demo-View.png)

4. The proof generated by the feed generator is validated by the creators through the custom app view automatically.
