...
You can go to our app view https://bsky.hackingdecentralized.com/ to give TrueReach a try. The rough steps to use TrueReach are:

- Users generate or import a seed, then derive the public/private key pair from that seed.

![Generate/import user seed](figs/TrueReach-Demo-Seed.png)

- Users subscribe to TrueReach (the feed generator), and their public keys are automatically registered with it.

![Subscribe to TrueReach](figs/TrueReach-Demo-Feed.png)

- The users view the promoted content and spend the receipt automatically.

![View the promoted content](figs/TrueReach-Demo-View.png)

- The proof generated by the feed generator is automatically verified by the creators through the custom app view.

![Audit the proof](figs/TrueReach-Demo-Audit.png)
